...
function seed(): State {
  ...
  const users: TrackedUser[] = [
    ...
    },
    {
      ...
      strikes: 2,
      status: "timeout",
      firstSeen: now - 86400000 * 12,
      lastOffense: now - 3600000 * 2,
      totalMessages: 78,
      flaggedMessages: 6,
    },
    {
      id: "u3",
      username: "jenny_writes",
      avatarSeed: "jenny",
      strikes: 0,
      status: "active",
      firstSeen: now - 86400000 * 45,
      totalMessages: 892,
      flaggedMessages: 0,
    },
    {
      id: "u4",
      username: "angry_user42",
      avatarSeed: "angry",
      strikes: 1,
      status: "warned",
      firstSeen: now - 86400000 * 3,
      lastOffense: now - 3600000 * 5,
      totalMessages: 34,
      flaggedMessages: 2,
    },
    {
      ...
      strikes: 3,
      status: "banned",
      firstSeen: now - 86400000 * 5,
      lastOffense: now - 86400000,
      totalMessages: 12,
      flaggedMessages: 8,
    },
    {
  ...
  const messages: FlaggedMessage[] = [
    {
      id: "m1",
      content: "I really hate people from that group, they should be banned everywhere",
      author: "troll_master99",
      channel: "#general",
      platform: "Discord",
      ...
      warning: "high",
      method: "ml_model",
      confidence: { Normal: 0.05, Offensive: 0.18, "Hate Speech": 0.77 },
      action: "deleted",
      reviewed: false,
    },
    {
      id: "m2",
      content: "This is such a stupid idea, worst thing I've read today",
      author: "angry_user42",
      channel: "#feedback",
      platform: "Discord",
      ...
      warning: "medium",
      method: "ml_model",
      confidence: { Normal: 0.22, Offensive: 0.68, "Hate Speech": 0.1 },
      action: "warned",
      reviewed: true,
      moderatorNote: "Confirmed offensive tone",
    },
    {
      id: "m3",
      content: "kill it with fire lol this project is awesome",
      author: "alex_dev",
      channel: "#dev-chat",
      platform: "Discord",
      ...
      action: "none",
      reviewed: true,
      matchedKeyword: "kill it with fire",
    },
    {
      id: "m4",
      content: "get lost you idiot",
      author: "spam_account",
      channel: "#general",
      platform: "Discord",
      ...
      warning: "medium",
      method: "keyword",
      matchedKeyword: "idiot",
      confidence: { Normal: 0.15, Offensive: 0.72, "Hate Speech": 0.13 },
      action: "deleted",
      reviewed: true,
    },
    {
      id: "m5",
      content: "the ML pipeline for this model is really well documented",
      author: "jenny_writes",
      channel: "#ml-discuss",
      platform: "Reddit",
      ...
      warning: "safe",
      method: "ml_model",
      confidence: { Normal: 0.94, Offensive: 0.05, "Hate Speech": 0.01 },
      action: "none",
      reviewed: true,
    },
    {
      id: "m6",
      content: "your kind doesn't belong on this platform, leave",
      author: "spam_account",
      ...
      warning: "high",
      method: "ml_model",
      confidence: { Normal: 0.08, Offensive: 0.24, "Hate Speech": 0.68 },
      action: "banned",
      reviewed: true,
    },
    {
      id: "m7",
      content: "this thread is trash, delete it",
      author: "angry_user42",
      channel: "#feedback",
      platform: "HackerNews",
      ...
      warning: "low",
      method: "ml_model",
      confidence: { Normal: 0.42, Offensive: 0.52, "Hate Speech": 0.06 },
      action: "logged",
      reviewed: false,
    },
  ];
...
export const store = {
    ...
    set((s) => {
      ...
      if (existing) {
        return {
          ...
          users: s.users.map((u) =>
            u.username === username
              ? { ...u, ...patch, totalMessages: (u.totalMessages ?? 0) + 1 }
              : u,
          ),
        };
      }
    ...
    set((s) => {
      const users = s.users.map((u) => {
        ...
        const status: UserStatus =
          newStrikes >= 3 ? "banned" : newStrikes === 2 ? "timeout" : "warned";
        updated = {
          ...u,
          strikes: newStrikes,
          status,
          lastOffense: Date.now(),
          flaggedMessages: u.flaggedMessages + 1,
        };
        return updated;
      });
      if (!updated) {
  ...
  resetUserStrikes(id: string) {
    set((s) => ({
      ...s,
      users: s.users.map((u) => (u.id === id ? { ...u, strikes: 0, status: "active" } : u)),
    }));
  },

...
import { store, type UserStatus } from "@/lib/store";
    ...
    <div className="p-6 lg:p-10 max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
        {[
          ...
          { k: "suspended", l: "Suspended", c: counts.suspended, tone: "text-chart-2" },
        ...
        <div className="flex gap-3 flex-wrap items-center">
          ...
          <Select value={status} onValueChange={setStatus}>
            ...
            <SelectContent>
              ...
              <SelectItem value="timeout">Suspended</SelectItem>
            ...
            {filtered.map((u) => {
              ...
              return (
                <TableRow key={u.id}>
                      ...
                      <div>
                        ...
                        {u.last_seen && (
                          <div className="text-[11px] text-muted-foreground">
                            since {formatDistanceToNow(u.last_seen, { addSuffix: true })}
                          </div>
                        )}
                      </div>
                    </div>
                  ...
                  <TableCell>
                    <span
                      className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full border text-[11px] font-medium ${s.cls}`}
                    >
                    ...
                    <div className="inline-flex gap-1">
                      {[0, 1, 2].map((i) => {
                        return (
                          <span
                            key={i}
                            className={`w-2 h-2 rounded-full ${i < currentUserStrikes ? "bg-destructive" : "bg-muted"}`}
                          />
                        );
                      })}

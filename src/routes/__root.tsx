  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center glass-panel rounded-2xl p-10">
        <h1 className="text-6xl font-display font-bold bg-gradient-primary bg-clip-text text-transparent">404</h1>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center glass-panel rounded-2xl p-10">
        ...
        <p className="mt-2 text-sm text-muted-foreground">The dashboard didn't load. Try again below.</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "DiscourseGuard — ML Hate Speech Moderation" },
      { name: "description", content: "Real-time ML-powered hate speech detection and moderation dashboard for Discord, Reddit and HackerNews communities." },
      { property: "og:title", content: "DiscourseGuard — ML Hate Speech Moderation" },
      { property: "og:description", content: "Three-layer moderation pipeline: safe-phrase override, keyword rules, and Logistic Regression + SMOTE (Macro F1 0.74)." },
